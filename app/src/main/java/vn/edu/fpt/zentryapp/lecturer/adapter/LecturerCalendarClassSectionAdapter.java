...
public class LecturerCalendarClassSectionAdapter extends RecyclerView.Adapter<LecturerCalendarClassSectionAdapter.CalendarSessionViewHolder> {

    private List<CalendarSession> sessions = new ArrayList<>();
    private OnLecturerCalendarClassSectionListener listener;

    public interface OnLecturerCalendarClassSectionListener {
    ...
    public void setOnSessionClickListener(OnLecturerCalendarClassSectionListener listener) {
