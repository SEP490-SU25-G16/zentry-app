...
/**
 * Encapsulates Face ID update action using FaceIdProcessor.
 */
public class FaceUpdateAction {
    ...
    public void execute(@NonNull FaceIdProcessor processor,
        ...
        processor.registerFace(bitmap, faceRect, ovalRect, userId, new FaceIdProcessingCallback() {
            @Override
